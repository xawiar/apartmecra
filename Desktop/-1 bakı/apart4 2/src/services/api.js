...
export const getDebts = apiService.getDebts;
export const createDebt = apiService.createDebt;
export const updateDebt = apiService.updateDebt;
export const deleteDebt = apiService.deleteDebt;
export const getChecks = apiService.getChecks;
export const createCheck = apiService.createCheck;
export const updateCheck = apiService.updateCheck;
export const deleteCheck = apiService.deleteCheck;
export const getSiteUpdateRequests = apiService.getSiteUpdateRequests;
export const createSiteUpdateRequest = apiService.createSiteUpdateRequest;
export const updateSiteUpdateRequest = apiService.updateSiteUpdateRequest;
export const deleteSiteUpdateRequest = apiService.deleteSiteUpdateRequest;
export const getCompanyUpdateRequests = apiService.getCompanyUpdateRequests;
export const createCompanyUpdateRequest = apiService.createCompanyUpdateRequest;
export const updateCompanyUpdateRequest = apiService.updateCompanyUpdateRequest;
export const deleteCompanyUpdateRequest = apiService.deleteCompanyUpdateRequest;
export const getNotifications = apiService.getNotifications;
export const createNotification = apiService.createNotification;
...
export const sendNotificationToSite = apiService.sendNotificationToSite;
export const sendAnnouncementToAllSites = apiService.sendAnnouncementToAllSites;
...
export const createMeeting = apiService.createMeeting;
export const updateMeeting = apiService.updateMeeting;
export const deleteMeeting = apiService.deleteMeeting;
